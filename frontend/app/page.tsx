    ...
    <main className="overflow-hidden">
        ...
        <div className="relative grid items-center gap-14 lg:grid-cols-[1.05fr_.95fr]">
          <div className="fade-up max-w-3xl">
            ...
            <div id="about" className="mt-14 grid max-w-2xl grid-cols-3 gap-7 border-t border-black/8 pt-7 text-xs text-black/45">
              ...
              <div><strong className="block text-2xl text-black">Held-out</strong>test evaluation</div>
          ...
          <div className="relative min-h-[520px]">
            ...
            <div className="float absolute left-[9%] top-[13%] w-[72%] rounded-[28px] border border-white/10 bg-white/8 p-5 text-white backdrop-blur-xl">
              <div className="flex items-center justify-between"><span className="text-xs uppercase tracking-[.18em] text-white/45">Risk score</span><span className="rounded-full bg-[#c8ff32] px-2.5 py-1 text-[10px] font-black text-black">HIGH</span></div>
            ...
            <div className="absolute right-[2%] top-[43%] w-[54%] rounded-[28px] border border-black/8 bg-white/78 p-5 shadow-xl backdrop-blur-xl">
              <div className="text-xs uppercase tracking-[.18em] text-black/40">Transaction</div>
            ...
            <div className="absolute bottom-[7%] left-[4%] w-[65%] rounded-[28px] border border-white/10 bg-white/6 p-5 text-white shadow-2xl backdrop-blur-xl">
      ...
      <section className="border-y border-black/6 bg-white/35 py-7">
        <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-5 px-5 text-xs uppercase tracking-[.16em] text-black/38 lg:px-8">
          <span>Razorpay Hackathon Track</span><span>Fraud · Returns · Chargebacks</span><span>Synthetic demo data</span><span>Held-out evaluation</span>
        </div>
      </section>
    </main>
  );
