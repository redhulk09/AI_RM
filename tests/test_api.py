...
def payload():
    return {"amount": 42850, "currency": "INR", "customer_id": "TEST_CUST_API", "account_age_days": 24, "device_id": "TEST_DEV_API", "country": "IN", "transactions_last_10m": 8, "transactions_last_1h": 16, "failed_payments": 4, "previous_transaction_amount": 10100, "previous_avg_amount": 10100, "is_new_device": True, "is_new_location": True, "distance_from_previous_location": 2100, "device_transaction_count": 15, "ip_transaction_count": 18, "customer_transaction_count": 18, "payment_method": "card", "hour": 2}
...
def test_predict_persists_transaction_and_prediction():
    ...
    assert detail.json()["transaction"]["amount"] == body["amount"]
...
def test_batch_predict_rejects_malformed_or_unsafe_binary_flags():
