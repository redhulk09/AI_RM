...
def base_row():
    return {
        "transaction_id": "TEST_TXN", "amount": 2200.0, "currency": "INR", "customer_id": "TEST_CUST", "account_age_days": 500,
        "device_id": "TEST_DEV", "country": "IN", "transactions_last_10m": 1, "transactions_last_1h": 3, "failed_payments": 0,
        "previous_transaction_amount": 2100.0, "previous_avg_amount": 2100.0, "amount_deviation": 1.05, "is_new_device": False,
        "is_new_location": False, "distance_from_previous_location": 20, "device_transaction_count": 2, "ip_transaction_count": 1,
        "payment_method": "upi", "hour": 13, "customer_transaction_count": 60,
    }
